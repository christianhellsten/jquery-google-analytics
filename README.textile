...
* track - Used in combination with jQuery selectors to add click tracking to matching elements.
* trackEvent - Same as _pageTracker.trackEvent, but checks that analytics isn't blocked by user.
...
* skip_internal - Default false. If true then internal links are not tracked.
